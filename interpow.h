...
uint32_t get_death_count(__task*);
void clear_death_count(__task*);
 ...
 *
 * \brief
 * Get a task's death count.
 *
 * @param TASK  task whose death count has to be returned
 *
